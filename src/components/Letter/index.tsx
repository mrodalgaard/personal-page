  ...
  return (
    <Container>
      ...
      <p>
        ...
        is a <Age birthday="08-22-1986" updateInterval={100} /> year old engineer living in Aarhus,
        Denmark, with his wonderful girlfriend Rikke and his daughter Gry.
      </p>
      <p>
        He is educated in{' '}
      ...
      <p>
        The gear he <u>can</u> live without (but doesn&#39;t want to) includes his 16" MacBook Pro,
        a broken iPhone X, an old Canon 550D, a converted Giant racing bike and an Omega Seamaster
        Aqua Terra on his wrist.
      </p>
