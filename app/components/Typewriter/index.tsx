...
const extractTextFromElement = (element: ReactNode | HTMLCollection): any[] => {
...
export default function Typewriter({
  ...
  const lines = useMemo(() => extractTextFromElement(children).map((line: string[]) => line.join('')), [children]);
